...
impl MachineSocket {
    ...
    async fn connect_with_recovery(
        ...
        socket.send(Message::Text(json!({"type":"hello","protocol_version":process_execution_protocol::VERSION,"installation_id":installation,"host_id":machine,"request_recovery":recovery,
            "runtime":{"generation_id":generation,"default_shell":{"executable":"sh","kind":"sh"},"pty":true,"pipe_interrupt":true,"terminal_interrupt":true,"filesystem":{"max_read_bytes":5242880,"max_write_bytes":5242880,"conditional_mutations":true,"atomic_replace":true},"shell_snapshot":{"enabled":true,"supported":true,"max_scope_id_bytes":256},"execution_run":{"max_preview_bytes":1048576,"output_retention_ms":86400000,"terminate_by_run_id":true}},
